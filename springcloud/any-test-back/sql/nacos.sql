/*
 ...
 Source Server         : local-linex7
 Source Server Type    : MySQL
 Source Server Version : 80020
 Source Host           : 192.168.100.130:3307
 Source Schema         : nacos
...
-- ----------------------------
INSERT INTO `config_info` VALUES (1, 'service-one-dev.yaml', 'DEFAULT_GROUP', 'server:\r\n  port: 8001\r\nspring:\r\n  application:\r\n    name: service-one\r\n  cloud:\r\n    nacos:\r\n      discovery:\r\n        server-addr: 192.168.100.130:8848\r\n\r\n\r\n\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource\r\n    driver-class-name: com.mysql.jdbc.Driver\r\n    url: jdbc:mysql://192.168.100.130:3307/test_demo?serverTimezone=Asia/Shanghai\r\n    username: root\r\n    password: 123456\r\n    hikari:\r\n      connection-test-query: SELECT 1 # 自动检测连接\r\n      connection-timeout: 60000 #数据库连接超时时间,默认30秒\r\n      idle-timeout: 500000 #空闲连接存活最大时间，默认600000（10分钟）\r\n      max-lifetime: 540000 #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟\r\n      maximum-pool-size: 12 #连接池最大连接数，默认是10\r\n      minimum-idle: 10 #最小空闲连接数量\r\n      pool-name: SPHHikariPool # 连接池名称\r\n\r\n', '3ba3beefeca79c52948a0d4b1b427faa', '2024-05-19 04:02:05', '2024-05-19 04:02:05', NULL, '192.168.100.1', '', '', NULL, NULL, NULL, 'yaml', NULL);
...
-- ----------------------------
INSERT INTO `his_config_info` VALUES (0, 1, 'service-one-dev.yaml', 'DEFAULT_GROUP', '', 'server:\r\n  port: 8001\r\nspring:\r\n  application:\r\n    name: service-one\r\n  cloud:\r\n    nacos:\r\n      discovery:\r\n        server-addr: 192.168.100.130:8848\r\n\r\n\r\n\r\n  datasource:\r\n    type: com.zaxxer.hikari.HikariDataSource\r\n    driver-class-name: com.mysql.jdbc.Driver\r\n    url: jdbc:mysql://192.168.100.130:3307/test_demo?serverTimezone=Asia/Shanghai\r\n    username: root\r\n    password: 123456\r\n    hikari:\r\n      connection-test-query: SELECT 1 # 自动检测连接\r\n      connection-timeout: 60000 #数据库连接超时时间,默认30秒\r\n      idle-timeout: 500000 #空闲连接存活最大时间，默认600000（10分钟）\r\n      max-lifetime: 540000 #此属性控制池中连接的最长生命周期，值0表示无限生命周期，默认1800000即30分钟\r\n      maximum-pool-size: 12 #连接池最大连接数，默认是10\r\n      minimum-idle: 10 #最小空闲连接数量\r\n      pool-name: SPHHikariPool # 连接池名称\r\n\r\n', '3ba3beefeca79c52948a0d4b1b427faa', '2010-05-05 00:00:00', '2024-05-19 04:02:05', NULL, '192.168.100.1', 'I', '');
